...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flex = FlexUnlimited()
    link, code = flex.generate_challenge_link()
    print(link)
...
async def show_buttons(update: Update) -> None:
    buttons = [
        [InlineKeyboardButton("Buscar", callback_data="search_command")],
        [InlineKeyboardButton("Configurar", callback_data="help_command")]
    ]
...
# Callback para manejar la pulsación de botones
...
def main() -> None:
    ...
    # Manejador para los clicks en botones
